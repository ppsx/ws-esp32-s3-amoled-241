...
BACKEND_NAME = "DL"
NOTE = "DL is benchmarked as a single group. BUFFER_DOUBLE is intentionally not part of the consolidated suite. Retained tests use copy=True."
MODE_GROUPS = (
    {"name": "DL", "buffer_mode": rm690b0.BUFFER_SINGLE, "render_mode": rm690b0.RENDER_DISPLAY_LIST, "copy_scene": False, "copy_retained": True, "prime_double": False},
)

run_profile("standard", BACKEND_NAME, NOTE, MODE_GROUPS)
