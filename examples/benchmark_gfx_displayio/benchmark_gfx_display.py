...
Hardware: Waveshare ESP32-S3 AMOLED 2.41" (600x450)
"""
...
def main():
    ...
    runner.run_test(
        "hline - short (50px)", "Lines",
        lambda: dc.hline(100, 100, 50, 0xFFFF),
        iterations=1000,
    )
    runner.run_test(
        "hline - medium (200px)", "Lines",
        lambda: dc.hline(100, 100, 200, 0xFFFF),
        iterations=500,
    )
    runner.run_test(
        "hline - long (500px)", "Lines",
    ...
    runner.run_test(
        "vline - short (50px)", "Lines",
        lambda: dc.vline(100, 100, 50, 0xFFFF),
        iterations=1000,
    )
    runner.run_test(
        "vline - medium (200px)", "Lines",
        lambda: dc.vline(100, 100, 200, 0xFFFF),
        iterations=500,
    )
    runner.run_test(
        "vline - long (400px)", "Lines",
    ...
    runner.run_test(
        "line - short diagonal (50px)", "Lines",
        lambda: dc.line(100, 100, 150, 150, 0xFFFF),
        iterations=500,
    )
    runner.run_test(
        "line - medium diagonal (200px)", "Lines",
        lambda: dc.line(100, 100, 300, 300, 0xFFFF),
        iterations=200,
    )
    runner.run_test(
        "line - long diagonal (400px)", "Lines",
    ...
    runner.run_test(
        "fill_rect - tiny (10x10)", "Rectangles",
        lambda: dc.fill_rect(100, 100, 10, 10, 0x07E0),
        iterations=1000,
    )
    runner.run_test(
        "fill_rect - small (50x50)", "Rectangles",
        lambda: dc.fill_rect(100, 100, 50, 50, 0x07E0),
        iterations=500,
    )
    runner.run_test(
        "fill_rect - medium (100x100)", "Rectangles",
        lambda: dc.fill_rect(100, 100, 100, 100, 0x07E0),
        iterations=200,
    )
    runner.run_test(
        "fill_rect - large (200x200)", "Rectangles",
        lambda: dc.fill_rect(100, 100, 200, 200, 0x07E0),
        iterations=100,
    )
    runner.run_test(
        "fill_rect - huge (400x300)", "Rectangles",
        lambda: dc.fill_rect(100, 75, 400, 300, 0x07E0),
        iterations=50,
    )
    runner.run_test(
        "fill_rect - full screen (600x450)", "Rectangles",
    ...
    runner.run_test(
        "circle - 10 circles (r=10-100)", "Circles",
        draw_10_circles,
        iterations=10,
    ...
    runner.run_test(
        "fill_circle - small (r=10)", "Circles",
        lambda: dc.fill_circle(300, 225, 10, 0xF81F),
        iterations=200,
    )
    runner.run_test(
        "fill_circle - medium (r=50)", "Circles",
        lambda: dc.fill_circle(300, 225, 50, 0xF81F),
        iterations=50,
    )
    runner.run_test(
        "fill_circle - large (r=100)", "Circles",
        lambda: dc.fill_circle(300, 225, 100, 0xF81F),
        iterations=20,
    )
    runner.run_test(
        "fill_circle - huge (r=200)", "Circles",
